...
public class Program {
    ...
    public static Expression p16 = new Expression.LetExpression(
            new Name("count"),
            new Expression.IntConstant(0),
            new Expression.BinOpExpression(
                    Expression.BinOpExpression.Operation.PLUS,
                    new Expression.IncExpression(new Name("count")),
                    new Expression.IncExpression(new Name("count"))
            )
    );

    // let count = 0 in ++count ; ++count ; ++count ; ++count ; count
    public static Statement p17 = new Expression.LetExpression(
            new Name("count"),
            new Expression.IntConstant(0),
            new Statement.SeqStatement(
                    new Expression.IncExpression(new Name("count")),
                    new Expression.IncExpression(new Name("count")),
                    new Expression.IncExpression(new Name("count")),
                    new Expression.IncExpression(new Name("count")),
                    new Expression.VariableExpression(new Name("count"))
            )
    );


    // let variable = 0 in variable = (400 + 70) ; (variable + 4)
    public static Statement p18 = new Expression.LetExpression(
            new Name("variable"),
            new Expression.IntConstant(0),
            new Statement.SeqStatement(
                    new Statement.SetStatement(
                            new Name("variable"),
                            new Expression.BinOpExpression(
                                    Expression.BinOpExpression.Operation.PLUS,
                                    new Expression.IntConstant(400),
                    ...
                    new Expression.BinOpExpression(
                            Expression.BinOpExpression.Operation.PLUS,
                            new Expression.VariableExpression(new Name("variable")),
                            new Expression.IntConstant(4)
                    )
            )
    );
    ...
    //   fact(10)
    public static Statement p19 = new Expression.LetExpression(
            new Name("fact"),
            new Expression.FirstClassFunctionDeclExpression(
                    new Name("fact"),
                    new Name[] { new Name("n") },
                            ...
                            new Expression.LetExpression(
                                    ...
                                    new Statement.SeqStatement(
                                            new Statement.WhileStatement(
                                                    new Expression.NeqExpression(
                                                            new Expression.VariableExpression(new Name("i")),
                                                            new Expression.VariableExpression(new Name("n"))
                                                    ),
                                                    new Statement.SeqStatement(
                                                            new Statement.SetStatement(
                                                                    ...
                                                                    new Expression.BinOpExpression(
                                                                            Expression.BinOpExpression.Operation.TIMES,
                                                                            new Expression.VariableExpression(new Name("ret")),
                                                                            new Expression.VariableExpression(new Name("i"))
                                                                    )
                                                            ),
                                                            new Expression.IncExpression(new Name("i"))
                                                    )
                                            ),
                                            new Expression.VariableExpression(new Name("ret"))
                                    )
    ...
    //   fact(10)
    public static Statement p20 = new Expression.LetExpression(
            new Name("fact"),
            new Expression.FirstClassFunctionDeclExpression(
                    new Name("fact"),
                    new Name[] { new Name("n") },
                    new Expression.LetExpression(
                            ...
                            new Expression.LetExpression(
                                    ...
                                    new Expression.IntConstant(1),
                                    new Statement.SeqStatement(
                                            new Statement.LoopStatement(
                                                    new Expression.IfExpression(
                                                            new Expression.EqExpression(
                                                                    new Expression.VariableExpression(new Name("n")),
                                                                    new Expression.VariableExpression(new Name("i"))
                                                            ),
                                                            new Statement.ReturnStatement(new Expression.VariableExpression(new Name("ret"))),
                                                            new Statement.SeqStatement(
                                                                    new Statement.SetStatement(
                                                                            new Name("ret"),
                                                                            new Expression.BinOpExpression(
...
//        Map<String, Value> environemnt = new HashMap<>();
        ...
        System.out.println(new Interpreter().eval(p16, environment));
    }
}
